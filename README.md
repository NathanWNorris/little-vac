...
Version **1.5.1** simplifies the workshop title screen to its illustrated vacuum, large cream-and-red lettering, a short menu, and one room caption beneath Continue. Progress and saved coins are available in Rooms and Upgrades. Popups share the title screen’s cream-paper and red treatment. Opening Upgrades during a job asks just once: **Keep playing** or **Quit & upgrade**, with the loss of unfinished cleaning and coins explained before quitting. Help and Settings opened from Pause return there; Main menu keeps the unfinished job paused. The three-picture **Move, Clean, Empty** guide and final-piece dirt markers remain available.
