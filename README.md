...
Version **1.5.2** carries the workshop title screen’s cream, dark green, and red palette into gameplay. The room sits in a paper frame with matching headings, status bars, controls, and start instructions; each location keeps its distinct floor and furniture artwork. Home keeps its short menu and one room caption beneath Continue. Opening Upgrades during a job asks just once: **Keep playing** or **Quit & upgrade**, with the loss of unfinished cleaning and coins explained before quitting. Help and Settings opened from Pause return there; Main menu keeps the unfinished job paused. The three-picture **Move, Clean, Empty** guide and final-piece dirt markers remain available.
