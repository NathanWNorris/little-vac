...
export function shopMarkup(career, active) {
  ...
  return `<div class="page-head"><div><h1>Upgrades</h1><p>${active?'Spend saved coins. Upgrades work when you resume.':'Spend coins earned from completed rooms.'}</p></div>${coinBalance(career.coins,'balance')}</div>
