...
function startInstructions(){return `<div id="roomStart" class="room-start" ${run.started?'hidden':''} role="region" aria-labelledby="startTitle"><div class="start-card"><h2 id="startTitle">Ready to clean?</h2><p class="start-steer"><span class="mouse-copy">Move your mouse to steer. No holding.</span><span class="touch-copy">Drag the pad or room to steer.</span><br>Your vacuum cleans automatically.</p><p class="start-rules"><strong>Bag full?</strong> Park beside a green dock.<br><strong>95% clean?</strong> Room done. Spend your coins on upgrades.</p>${action('begin-room','<span class="mouse-copy">Left-click to start</span><span class="touch-copy">Tap to start</span>','primary')}<p class="start-keys">Enter to start · WASD / arrows to move · Esc to pause</p></div></div>`;}
