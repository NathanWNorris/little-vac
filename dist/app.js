...
function gameHUD(){
  ...
  else if(r.percent>=.95){const left=r.debris.filter(d=>!d.collected).length;tip=`${left} ${left===1?'piece':'pieces'} left. Golden rings mark every remaining bit, including faint dust.`;}
