...
function upgradeLocked(){
  if(modal.open)modal.close();
  openModal(`<h2 id="modalTitle">Leave this job?</h2><p>Quit this job to open Upgrades. You’ll lose its unfinished cleaning and coins.</p><p>Your saved coins and upgrades stay.</p><div class="button-row">${action('resume-room','Keep playing','primary')}${action('quit-confirm','Quit & upgrade')}</div>`);
}
